...
-- Ctrl+D/U keep curor in the middle of the screen
vim.keymap.set('n', '<C-d>', '<C-d>zz')
vim.keymap.set('n', '<C-u>', '<C-u>zz')

-- Keeps searches in the middle of the window.
...
-- Create an autocmd group to keep things organized and avoid duplicates
...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function()
    ...
    -- Enable wrap and linebreak for nice word wrapping
...
vim.api.nvim_create_autocmd('FileType', {
  ...
  pattern = 'text',
  callback = function()
    -- Set textwidth to 72 for txt files
    vim.opt_local.textwidth = 80
    vim.opt_local.wrap = true
    vim.opt_local.linebreak = true
...
-- Set up kanagawa-dragon as the colorscheme
-- Default options:
