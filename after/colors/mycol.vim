" based on habamax, eddited by Aidan Griffiths
"
set background=dark
...
hi Normal guifg=#bcbcbc guibg=#1C1D2A gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi CursorLineNr ctermfg=215 ctermbg=NONE cterm=bold,italic
